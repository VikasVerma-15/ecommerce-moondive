    ...
    <main className="flex-grow flex flex-col bg-white">
      <section className="section-width px-4 xl:px-0 py-10 mt-10 min-h-screen">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-black">All Best Selling Products</h1>
        </div>

        <p className="text-gray-500 mb-10 max-w-2xl">
          Browse all of our most popular and best selling products of the month.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {products.length > 0 ? (
            ...
            <p className="text-gray-500 col-span-full py-12 text-center text-lg">No best selling products available right now.</p>
          )}
        </div>
      </section>
    </main>
